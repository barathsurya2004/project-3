...
export function FaceModel(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/models1/face.glb");
  ...
  useEffect(() => {
    ...
    tl.to(meshRef1.current.material.color, {
      r: 1,
      g: 0,
      b: 0,
      duration: 0.1,
    });
    tl.to(meshRef.current.material.color, { r: 1, g: 0, b: 0, duration: 0.1 });
